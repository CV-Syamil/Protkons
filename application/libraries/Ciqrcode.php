...
class Ciqrcode
{
	...
	public function generate($params = array()) {
		...
		if (isset($params['savename'])) {
			...
			QRcode::png($params['data'], $params['savename'], $level, $size, 3);
			// QRcode::png($params['data'], $params['savename'], $level, $size, 2,0,0,"0,0,0","255,255,255",FCPATH.'assets/images/duser.png');
			...
			QRcode::png($params['data'], NULL, $level, $size, 3);
		}
	}
}
